#include "stdafx.h"
#include "VtAssetGrid.h"
#include "VtAssetPage.h"
#include <numeric>

VtAssetGrid::VtAssetGrid()
{
}
...
void VtAssetGrid::OnDClicked(int col, long row, RECT *rect, POINT *point, BOOL processed)
{

}

void VtAssetGrid::OnLClicked(int col, long row, int updn, RECT *rect, POINT *point, int processed)
{

}

void VtAssetGrid::SetRowTitle()
{
...
void VtAssetGrid::QuickRedrawCell(int col, long row)
{
	CRect rect;
...
void VtAssetGrid::InitGrid()
{
	try
	{
		CString msg;
		msg.Format("VtAssetGrid::InitGrid\n");
		//TRACE(msg);
		/*
