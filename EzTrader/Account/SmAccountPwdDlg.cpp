...
{
	if (IDYES == AfxMessageBox("���º��й�ȣ�� ��ġ���� �ʽ��ϴ�.\n5ȸ������ �������ͷ� ���ǹٶ��ϴ�.\n���� �����Ͻðڽ��ϱ�?", MB_YESNO)){
		//AfxMessageBox("OK����");
		SetTimer(1, 700, NULL);
	}
	else if (IDNO) {
...
BOOL SmAccountPwdDlg::OnInitDialog()
{
	...
	m_wndGrid.InsertColumn(1, _T("���¹�ȣ"), 80);
	m_wndGrid.InsertColumn(2, _T("���й�ȣ"), 80);
	m_wndGrid.InsertColumn(3, _T("Ȯ������"), rect.Width() - 246);
