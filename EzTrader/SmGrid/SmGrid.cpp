...
void DarkHorse::SmGrid::RegisterOrderButtons(std::map<std::shared_ptr<DarkHorse::SmCell>, BUTTON_ID>& order_button_map)
{
	...
	SetCellText(1, DarkHorse::OrderHeader::SELL_CNT, "���尡�ŵ�");
	SetCellText(1, DarkHorse::OrderHeader::BUY_QTY, "���尡�ż�");
	...
	SetCellText(1, DarkHorse::OrderHeader::QUOTE, "ȣ������");
	...
	SetCellText(_RowCount - 1, DarkHorse::OrderHeader::SELL_STOP, "����");
	SetCellText(_RowCount - 1, DarkHorse::OrderHeader::SELL_ORDER, "����");
	SetCellText(_RowCount - 1, DarkHorse::OrderHeader::QUOTE, "��ü����");
	SetCellText(_RowCount - 1, DarkHorse::OrderHeader::BUY_STOP, "����");
	SetCellText(_RowCount - 1, DarkHorse::OrderHeader::BUY_ORDER, "����");
}
