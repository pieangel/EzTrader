...
std::string CCrashHandler::dumpName;

CCrashHandler::CCrashHandler(std::string logname)
{	
	dumpName = logname;
}
...
{   
	...
	if (CCrashHandler::dumpName.empty())
		sprintf_s(dump_file_name, 256, "%04d-%02d-%02d_%02d-%02d-%02d_crashdump.dmp",
			systemtime.wYear, systemtime.wMonth, systemtime.wDay, systemtime.wHour, systemtime.wMinute, systemtime.wSecond);
	else
		sprintf_s(dump_file_name, 256, "%04d-%02d-%02d_%02d-%02d-%02d_%s(%u).dmp",
			systemtime.wYear, systemtime.wMonth, systemtime.wDay, systemtime.wHour, systemtime.wMinute, systemtime.wSecond,
			CCrashHandler::dumpName.c_str(), ::GetCurrentThreadId());
