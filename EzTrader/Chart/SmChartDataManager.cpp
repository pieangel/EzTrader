...
DarkHorse::SmChartDataManager::SmChartDataManager()
{
...
std::shared_ptr<DarkHorse::SmChartData> DarkHorse::SmChartDataManager::FindChartData(const std::string& chart_data_key)
{
...
std::shared_ptr<DarkHorse::SmChartData> DarkHorse::SmChartDataManager::FindChartData(const std::string& symbol_code, const SmChartType& chart_type, const int& cycle)
{
	std::string chart_data_key = MakeDataKey(symbol_code, static_cast<int>(chart_type), cycle);
	return FindChartData(chart_data_key);
}

std::shared_ptr<DarkHorse::SmChartData> DarkHorse::SmChartDataManager::FindAddChartData(const std::string& symbol_code, const SmChartType& chart_type, const int& cycle)
{
	std::string chart_data_key = MakeDataKey(symbol_code, static_cast<int>(chart_type), cycle);
...
void DarkHorse::SmChartDataManager::RequestChartData(const std::string& symbol_code, const int& window_id, const int& series_index)
{
...
void DarkHorse::SmChartDataManager::RequestChartData(const std::string& symbol_code, const SmChartType& chart_type, const int& cycle, const int& count, const int& window_id, const int& series_index)
{
	...
	SmTaskArg arg;
	arg.TaskType = SmTaskType::ChartData;
	arg.Param = req;
	mainApp.TaskReqMgr()->AddTask(std::move(arg));
}

void DarkHorse::SmChartDataManager::RequestChartData(const std::string& symbol_code, const SmChartType& chart_type, const int& cycle, const int& window_id, const int& series_index)
{
	const std::string& data_key = MakeDataKey(symbol_code, chart_type, cycle);
	std::shared_ptr<SmChartData> chart_data = FindChartData(data_key);
...
void DarkHorse::SmChartDataManager::CreateTimer(std::shared_ptr<SmChartData> chart_data)
{
