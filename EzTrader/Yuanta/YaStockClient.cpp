...
int YaStockClient::ConnectToServer()
{
	if (!_ViCtrol)
	{
...
{
	return 1; // return _ViCtrol->ab_symbol_master(std::move(arg));
}

int YaStockClient::GetSymbolQuote(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_symbol_quote(std::move(arg));
}

int YaStockClient::GetSymbolHoga(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_symbol_hoga(std::move(arg));
}

void YaStockClient::UnregisterAccount(task_arg&& arg)
{
	//_ViCtrol->unregister_account(std::move(arg));
}

void YaStockClient::RegisterAccount(task_arg&& arg)
{
	//_ViCtrol->register_account(std::move(arg));
}

void YaStockClient::UnregisterSymbol(task_arg&& arg)
{
	//_ViCtrol->unregister_symbol(std::move(arg));
}

void YaStockClient::RegisterSymbol(task_arg&& arg)
{
	//_ViCtrol->register_symbol(std::move(arg));
}

void YaStockClient::CancelOrder(task_arg&& arg)
{
	//_ViCtrol->ab_cancel_order(std::move(arg));
}

void YaStockClient::ChangeOrder(task_arg&& arg)
{
	//_ViCtrol->ab_change_order(std::move(arg));
}

void YaStockClient::NewOrder(task_arg&& arg)
{
	//_ViCtrol->ab_new_order(std::move(arg));
}

int YaStockClient::GetChartData(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_chart_data(std::move(arg));
}

int YaStockClient::GetFilledOrderList(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_filled_order_list(std::move(arg));
}

int YaStockClient::GetAcceptedOrderList(task_arg&& arg)
{
	return 1; // _ViCtrol->ab_accepted_order_list(std::move(arg));
}

int YaStockClient::GetSymbolProfitLoss(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_symbol_profit_loss(std::move(arg));
}

int YaStockClient::GetAccountProfitLoss(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_account_profit_loss(std::move(arg));
}

int YaStockClient::GetDeposit(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_account_deposit(std::move(arg));
}

int YaStockClient::GetAccountAsset(task_arg&& arg)
{
	return 1; // return _ViCtrol->ab_account_asset(std::move(arg));
}



int DarkHorse::YaStockClient::DownloadFile(task_arg&& arg)
{
	return 1; // return _ViCtrol->download_file(std::move(arg));
}



int YaStockClient::DownloadMasterFile(task_arg&& arg)
{
	return 1; // return _ViCtrol->download_symbol_master_file(std::move(arg));
}

int DarkHorse::YaStockClient::GetFilledOrderList(const std::string& account_no, const std::string& pwd)
{
...
{
	return 1; // return _ViCtrol->dm_symbol_profit_loss(arg);
}

int YaStockClient::ab_symbol_master_file_download(DhTaskArg arg)
{
	return 1; // return _ViCtrol->ab_symbol_master_file_download(arg);
}

int YaStockClient::dm_symbol_master_file_download(DhTaskArg arg)
{
	return 1; // return _ViCtrol->dm_symbol_master_file_download(arg);
}
...
void YaStockClient::dm_change_order(order_request_p order_req)
{
	//_ViCtrol->change_order(order_req);
}

void YaStockClient::dm_cancel_order(order_request_p order_req)
{
	//_ViCtrol->cancel_order(order_req);
}
...
void DarkHorse::YaStockClient::ChangeOrder(const std::shared_ptr<SmOrderRequest>& order_req)
{
	if (_TestMode) SendOrderAcceptedData(order_req);
	else {
		_OrderReqMap[order_req->RequestId] = order_req;
...
void DarkHorse::YaStockClient::CancelOrder(const std::shared_ptr<SmOrderRequest>& order_req)
{
	if (_TestMode) SendOrderAcceptedData(order_req);
	else {
		_OrderReqMap[order_req->RequestId] = order_req;
...
void DarkHorse::YaStockClient::SendOrderUnfilledData()
{
	nlohmann::json order_info;
...
void DarkHorse::YaStockClient::SendOrderFilledData()
{
	nlohmann::json order_info;
	order_info["account_no"] = "";
	order_info["order_no"] = "";
...
int DarkHorse::YaStockClient::CheckDmAccountPassword(task_arg&& arg)
{
	return 1; // return _ViCtrol->dm_check_account_password(std::move(arg));
}

void DarkHorse::YaStockClient::Enable(bool val)
{
	//_ViCtrol->Enable(val);
}

void DarkHorse::YaStockClient::UnRegAll()
{
...
void DarkHorse::YaStockClient::ExecTask(const SmTaskType& task_type, task_arg&& task)
{
	switch (task_type)
	{
...
void DarkHorse::YaStockClient::ExecTask(DhTaskArg&& task)
{
...
void DarkHorse::YaStockClient::RemoveTask(const int& task_id)
{
	//_ViCtrol->remove_task(task_id);
}

void DarkHorse::YaStockClient::OnAccountReceived(nlohmann::json&& arg)
{
	try {
...
void DarkHorse::YaStockClient::OnSymbolMaster(nlohmann::json&& arg)
{
	try {
...
void DarkHorse::YaStockClient::OnSymbolQuote(nlohmann::json&& quote)
{
	mainApp.QuoteMgr()->AddQuote(std::move(quote));
}

void DarkHorse::YaStockClient::OnDmSymbolMaster(const std::string& symbol_code)
{
...
void DarkHorse::YaStockClient::on_dm_expected(nlohmann::json&& quote)
{
...
void DarkHorse::YaStockClient::on_dm_commodity_future_quote(nlohmann::json&& quote)
{
	mainApp.QuoteMgr()->AddQuote(std::move(quote));
}
void DarkHorse::YaStockClient::on_dm_commodity_future_hoga(nlohmann::json&& hoga)
{
	mainApp.HogaMgr()->AddHoga(std::move(hoga));
}

void DarkHorse::YaStockClient::on_dm_option_quote(nlohmann::json&& quote)
{
	mainApp.QuoteMgr()->AddQuote(std::move(quote));
}
void DarkHorse::YaStockClient::on_dm_option_hoga(nlohmann::json&& hoga)
{
	mainApp.HogaMgr()->AddHoga(std::move(hoga));
}

void DarkHorse::YaStockClient::OnDmSymbolQuote(nlohmann::json&& quote)
{
	mainApp.QuoteMgr()->AddQuote(std::move(quote));
}

void DarkHorse::YaStockClient::OnSymbolHoga(nlohmann::json&& hoga)
{
	mainApp.HogaMgr()->AddHoga(std::move(hoga));
}


void DarkHorse::YaStockClient::OnDmSymbolHoga(nlohmann::json&& hoga)
{
	mainApp.HogaMgr()->AddHoga(std::move(hoga));
}

void DarkHorse::YaStockClient::OnRealtimeQuote(nlohmann::json&& arg)
{
	mainApp.QuoteMgr()->AddQuote(std::move(arg));
}

void DarkHorse::YaStockClient::OnRealtimeHoga(nlohmann::json&& arg)
{
	mainApp.HogaMgr()->AddHoga(std::move(arg));
}

void DarkHorse::YaStockClient::on_ab_account_asset(nlohmann::json&& arg)
{
...
void DarkHorse::YaStockClient::on_dm_account_asset(nlohmann::json&& arg)
{
	const std::string account_no = arg["account_no"];
	const auto account = mainApp.AcntMgr()->FindAccount(account_no);
	if (!account) return;
...
void DarkHorse::YaStockClient::on_ab_symbol_profit_loss(nlohmann::json&& arg)
{
	try {
		const std::string account_no = arg["account_no"];
		const std::string symbol_code = arg["symbol_code"];
...
void DarkHorse::YaStockClient::on_symbol_profit_loss(nlohmann::json&& arg)
{
	try {
		const std::string& account_no = arg["account_no"];
		const std::string& symbol_code = arg["symbol_code"];
...
void DarkHorse::YaStockClient::on_dm_symbol_profit_loss(nlohmann::json&& arg)
{
	try {
		const std::string account_no = arg["account_no"];
		const std::string symbol_code = arg["symbol_code"];
...
void DarkHorse::YaStockClient::on_ab_symbol_position(nlohmann::json&& arg)
{
	try {
		const std::string symbol_code = arg["symbol_code"];
		const std::string account_no = arg["account_no"];
...
void DarkHorse::YaStockClient::OnAcceptedList(nlohmann::json&& arg)
{
	OnOrderAccepted(std::move(arg));
}

void DarkHorse::YaStockClient::on_ab_filled_order_list(nlohmann::json&& arg)
{
	OnOrderFilledList(std::move(arg));
}

int DarkHorse::YaStockClient::GetDomesticSymbolCode(task_arg&& arg)
{
	return 1; // return _ViCtrol->dm_symbol_code(std::move(arg));
}

void DarkHorse::YaStockClient::SetOrderAuxInfo(const std::shared_ptr<DarkHorse::SmOrder>& order)
{
...
void DarkHorse::YaStockClient::SendOrderEvent(const std::shared_ptr<SmOrder>& order)
{
...
std::shared_ptr<SmOrder> DarkHorse::YaStockClient::SetOrderAccepted(nlohmann::json&& arg)
{
	try {
...
void DarkHorse::YaStockClient::OnOrderAccepted(nlohmann::json&& arg)
{
...
std::shared_ptr<SmOrder> DarkHorse::YaStockClient::SetOrderUnfilled(nlohmann::json&& arg)
{
	try {
		const std::string order_no = arg["order_no"];
		std::shared_ptr<SmOrder> order = mainApp.TotalOrderMgr()->FindAddOrder(order_no);
...
void DarkHorse::YaStockClient::OnOrderUnfilled(nlohmann::json&& arg)
{
...
void DarkHorse::YaStockClient::OnOrderFilledList(nlohmann::json&& arg)
{
...
std::shared_ptr<SmOrder> DarkHorse::YaStockClient::SetOrderFilled(nlohmann::json&& arg)
{
	try {
		const std::string order_no = arg["order_no"];
		std::shared_ptr<SmOrder> order = mainApp.TotalOrderMgr()->FindAddOrder(order_no);
...
void DarkHorse::YaStockClient::OnOrderFilled(nlohmann::json&& arg)
{
	std::shared_ptr<SmOrder> order = SetOrderFilled(std::move(arg));
...
int YaStockClient::dm_symbol_master(DhTaskArg arg)
{
	return 1; // return _ViCtrol->dm_symbol_master(arg);
}
