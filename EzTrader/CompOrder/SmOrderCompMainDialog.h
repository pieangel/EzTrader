...
{
	DECLARE_DYNAMIC(SmOrderCompMainDialog)
...
public:
	...
	void SetAccount();
	void SetFund();
	SmOrderCompMainDialog(CWnd* pParent = nullptr);   // standard constructor
	virtual ~SmOrderCompMainDialog();
...
private:
	...
	std::shared_ptr<SmOrderLeftComp> _LeftWnd = nullptr;
	std::shared_ptr<SmOrderRightComp> _RightWnd = nullptr;
