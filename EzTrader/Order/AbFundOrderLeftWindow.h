...
class AbFundOrderLeftWindow : public CBCGPDialog
{
	DECLARE_DYNAMIC(AbFundOrderLeftWindow)

public:
	AbFundOrderLeftWindow(CWnd* pParent = nullptr);   // standard constructor
	virtual ~AbFundOrderLeftWindow();
...
public:
	...
	void SetMainWnd(AbFundOrderWindow* main_wnd);
