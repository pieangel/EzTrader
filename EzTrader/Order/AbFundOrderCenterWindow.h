...
class AbFundOrderCenterWindow : public CBCGPDialog
{
	DECLARE_DYNAMIC(AbFundOrderCenterWindow)

public:
	static int DeltaOrderArea;
	AbFundOrderCenterWindow(CWnd* pParent = nullptr);   // standard constructor
	virtual ~AbFundOrderCenterWindow();
