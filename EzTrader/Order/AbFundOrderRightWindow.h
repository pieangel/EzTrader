...
class AbFundOrderRightWindow : public CBCGPDialog
{
	DECLARE_DYNAMIC(AbFundOrderRightWindow)

public:
	AbFundOrderRightWindow(CWnd* pParent = nullptr);   // standard constructor
	virtual ~AbFundOrderRightWindow();
